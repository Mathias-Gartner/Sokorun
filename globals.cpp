...
/** SPIELGESCHWINDIGKEIT **/
    double FPS;                             //Die FPS des letzen Intervalls

    long frameArray[frameArraySize+1];      //Ringbuffer; Beinhaltet die Abschlusszeiten der letzten "frameArraySize" Frames
    int frameArrayIndex;                    //Zeigt auf den neusten Eintrag
    int lastFrameArrayIndex;                //Zeigt auf den ältesten Eintrag
...
TEXTURE lavaflow            ("daten/texturen/lavaflow.tga"                      ,{256,128}  ,{4,2});        //Animationsdatei: Bewegung von Lava
TEXTURE lavablubb           ("daten/texturen/lavablubb.tga"                     ,{256,256}  ,{4,4});        //Animationsdatei: Lavablase
...
float coordPixel=1.0f;      //Wieviele Pixel eine Koordinateneinheit am Bildschirm bekommt
